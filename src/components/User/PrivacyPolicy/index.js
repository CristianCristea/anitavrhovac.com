...
export default function PrivacyPolicy() {
  return (
    <div className="container privacy__policy__page">
      ...
      <Typography variant="body2" gutterBottom>
        Die Datenverarbeitung auf dieser Website erfolgt durch den Besitzer.
      ...
      <Typography variant="body2" gutterBottom>
        The data collected on this website are processed by the website owner.
        The contact details can be found in the website’s required legal notice.
      </Typography>
      ...
      <Typography variant="h6" gutterBottom>
        3. Data collection on our websitee
      </Typography>
      <Typography variant="subtitle1" gutterBottom>
        Cookies
      </Typography>
      ...
      <Typography variant="body2" gutterBottom>
        ...
        your data from being collected on future visits to this site
        <a href="https://tools.google.com/dlpage/gaoptout?hl=de.">
      ...
      <Typography variant="body2" gutterBottom>
        This website uses Google Analytics’ demographic features. This allows
        reports to be generated containing statements about the age, gender, and
        interests of site visitors. This data comes from interest-based
        advertising from Google and third-party visitor data. This collected
        data cannot be attributed to any specific individual person. You can
        disable this feature at any time by adjusting the ads settings in your
        Google account or you can forbid the collection of your data by Google
        Analytics as described in the section “Refusal of data collection”.
      </Typography>
